#ifndef __ORPHAN_CORE_INTEGRAL_H__
#define __ORPHAN_CORE_INTEGRAL_H__
/** @file
 * Core, low level C
 */
...
extern "C" {
	 ...
	 */
	ORPHAN_LOCAL_SYMBOL integral_digit
	...
	//integral_t* ORPHAN_EXPORT_SYMBOL div_rem(const integral_t* lhs, const integral_t* rhs);

	//integral_t* ORPHAN_EXPORT_SYMBOL mod(const integral_t* lhs, const integral_t* rhs);

	/**
	 * @brief increments a large number (an array of integral digits).
	 * @param[in,out] value the value to increment.
	 */
	ORPHAN_EXPORT_SYMBOL void integral_inc(integral_digit* value);

	/**
	 * @brief decrements a large number (an array of integral digits).
	 * @param[in,out] value the value to decrement.
	 */
	ORPHAN_EXPORT_SYMBOL void integral_dec(integral_digit* value);
